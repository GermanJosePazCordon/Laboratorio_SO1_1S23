...
{
    proc_create("modulo_clase6", 0, NULL, &operaciones);
    printk(KERN_INFO "Mensaje al insertar el modulo, Lab Clase 6\n");
    return 0;
}

static void _remove(void)
{
    remove_proc_entry("modulo_clase6", NULL);
    printk(KERN_INFO "Mensaje al remover el modulo, Lab Clase 6\n");
}
